...
export default function Sidebar( { open } : SidebarProps ) {
    ...
    // console.log("Curret path is:", pathname);
            ...
            <nav className="h-full flex flex-col justify-between">
                            ...
                            <Link href={item.href} key={item.href} passHref>
                                ...
                                <Button
                                    ...
                                    className= {`w-full justify-start py-3 ${
                                        pathname === item.href ? "bg-green-100 text-green-800 hover:scale-105 transition-all" : "text-gray-600 hover:bg-gray-100 hover:scale-105 transition-all"
                                    }`}
                                >
                ...
                <Link href="/settings" passHref>
                    ...
                    <Button 
                        ...
                        className={`w-full py-3 hover:scale-105 transition-all ${
                            pathname === "/settings"
